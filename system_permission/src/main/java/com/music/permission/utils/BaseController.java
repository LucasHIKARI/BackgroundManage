...
//			JDK8不支持setSameSite  普通的Cookie属性。其作用是限制该Cookie的在请求的时候是否被传递到Cookie所属服务的场景。
//			所以需要用响应头设置Set-Cookie，间接设置setSameSite
//			cookie.setSameSite("None");

			resp.setHeader("Set-Cookie", "sse=test7;path=/;HttpOnly;Domain=localhost;SameSite=none; Secure");
			resp.setHeader("Access-Control-Allow-Credentials", "true");
			//谁访问我，我允许谁 注意这个项目这里写死了http://localhost:8000
